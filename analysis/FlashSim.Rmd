...
After fit the flash model to the data, the value of objective function becomes worse. 
...
If we initialize the flash with 3 fixed factors
```{r}
ffixf = flash_add_fixed_f(data,FF=cbind(c(1,1,0,0,0),c(1,-1,0,0,0),
                                        c(0,0,-1,0,0),c(0,0,0,1,0),c(1,1,1,1,1), c(0,0,0,0,-1)))
flash_get_F(data,ffixf)
```
