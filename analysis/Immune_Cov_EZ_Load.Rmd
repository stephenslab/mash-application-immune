...
Besides the 3 types of data-driven covariance matrices created in [Immune_Cov_EZ](Immune_Cov_EZ.html), we have 1 more type of covariance:
...
```{r}
U_loading = readRDS('../output/Immune.flash.loading.reduce.cov.rds')
```
<!--
...
U.dd = c(U.flash, U.pca, list("XX" = t(D.center) %*% D.center / nrow(data$max$z)), U_loading)
