...
Most of the mass is on the null, PCA1 and equal effects. `mash` placed `r sum(get_estimated_pi(resEZ)[2:14])*100`% of the mixture components weight on data-driven matrices, `r get_estimated_pi(resEZ)['equal_effects']*100`% weight on equal effects matrix.

Here is a visualization for PCA1, which capture `r get_estimated_pi(resEZ)['ED_PCA_1']*100`% mixture component in these data, (via correlation heatmap):
