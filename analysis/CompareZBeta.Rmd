...
simdata.equal.subset = simdata.equal
simdata.equal.subset$Bhat = simdata.equal$Bhat[subset.data,]
simdata.equal.subset$Shat = simdata.equal$Shat[subset.data,]

TestdataBeta.equal.subset = set_mash_data(simdata.equal.subset$Bhat, simdata.equal.subset$Shat, alpha = 0)
TestdataZ.equal.subset = set_mash_data(simdata.equal.subset$Bhat, simdata.equal.subset$Shat, alpha = 1)
...
# EZ
U.m.Z.equal.posterior = mash_compute_posterior_matrices(U.m.Z.equal, TestdataZ.equal.subset, algorithm.version = 'R', A=A)
