---
title: "Immune Data Mash Analysis EZ V0 Results"
author: "Yuxin Zou"
date: 2017-11-15
...
The model is fitted in [Mash model EZ V0](Immune_Data_Mash_V0_EZ.html)
```{r}
# EZ
...
```{r echo=FALSE}
# Improved
stronggenePost = data.frame(resEZ$result$PosteriorMean[222,])
colnames(stronggenePost) = 'EffectSize'
stronggenePost$Group = row.names(stronggenePost)
stronggenePost$se = resEZ$result$PosteriorSD[222,]
