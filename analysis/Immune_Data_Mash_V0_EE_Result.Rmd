---
title: "Immune Data Mash Analysis EE V0 Results"
author: "Yuxin Zou"
date: 2017-11-16
...
The model is fitted in [Mash model EE V0](Immune_Data_Mash_V0_EE.html)
```{r}
# EE
...
Here is a visualization for tPCA, which capture `r round(get_estimated_pi(resEE)['ED_tPCA']*100,4)`% mixture component in these data, (via correlation heatmap):
...
```{r echo=FALSE}
# Improved
stronggenePost = data.frame(resEE$result$PosteriorMean[8306,])
colnames(stronggenePost) = 'EffectSize'
stronggenePost$Group = row.names(stronggenePost)
stronggenePost$se = resEE$result$PosteriorSD[8306,]
