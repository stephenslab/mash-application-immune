---
title: "Immune Data Mash Analysis EE V0"
author: "Yuxin Zou"
date: 2017-11-16
...
Using a random null set, the cell below computes the weights for input covariance matrices ([Covariance matrices](Immune_Cov_EE.html)) in MASH mixture. The output contains matrix of log-likelihoods as well as weights learned from the hierarchical model.
...
```{r}
U.m = readRDS('../output/ImmuneEE.V0.center.mash_model.K10.P5.rds')
